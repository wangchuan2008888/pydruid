...
class Bound(Filter):
    ...
    :ivar ExtractionFunction extraction_function: extraction function to use,
                                                  if not None
    """
    def __init__(self, dimension, lower, upper, lowerStrict=False,
                 upperStrict=False, alphaNumeric=False,
                 extraction_function=None):

        Filter.__init__(
            self, type='bound', dimension=dimension,
...
class Interval(Filter):
    ...
    def __init__(self, dimension, intervals, extraction_function=None):
        ...
        Filter.__init__(
            self, type='interval', dimension=dimension, intervals=intervals,
